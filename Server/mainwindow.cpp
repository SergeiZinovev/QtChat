...
void MainWindow::on_pushButton_DeleteUser_clicked()
{
  ...
  //Create screen to confirm user deleting
  QDialog dialog(this);
  ...
  QString message = "Are you sure to delete user: " + loginToDelete + " ?";
...
void MainWindow::on_pushButton_DeleteMessage_clicked()
{
  ...
  auto label = new QLabel(&dialog);
  QString message = "Are you sure to delete message: '" + messageText + "' ?";
  label->setText(message);
  label->setAlignment(Qt::AlignHCenter);
